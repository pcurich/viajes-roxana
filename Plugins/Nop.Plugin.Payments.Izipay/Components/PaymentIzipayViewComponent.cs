...
namespace Nop.Plugin.Payments.Izipay.Components
{
    [ViewComponent(Name = "PaymentIzipay")]
    public class PaymentIzipayViewComponent : NopViewComponent
    {
        public IViewComponentResult Invoke()
        {
            ...
            return View("~/Plugins/Payments.Izipay/Views/PaymentInfo.cshtml", model);
        }
    }
}
